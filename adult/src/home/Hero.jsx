        ...
        <div className="flex-1 max-w-xl text-center md:text-left">
          ...
          <p className="mt-2 sm:mt-3 text-[#2c2c2c] text-[13.5px] sm:text-[15.5px] leading-[1.6] font-medium">
            ...
            <span className="font-semibold">
              stress, anxiety, burnout, overthinking, poor sleep, or emotional
              exhaustion
            </span>{" "}
            — you're not alone, and there is a structured path forward.
          </p>
