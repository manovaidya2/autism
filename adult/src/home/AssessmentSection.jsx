  ...
  const data = [
    {
      ...
      desc: "Understand how stress may be impacting your mental clarity, energy, and daily well-being.",
    },
    {
      title: "Key Imbalance Areas Identified",
      desc: "Spot the major areas that may be contributing to emotional and physical overload.",
    },
    {
      title: "Brain–Gut–Nervous System Insight",
      desc: "See how your symptoms may be connected across multiple internal systems.",
    },
    {
      title: "Personalized Improvement Roadmap",
      desc: "Get simple next steps and practical guidance based on your responses.",
    },
  ];
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-center">
          ...
          <div className="flex-1 text-center lg:text-left">
            <h2 className="text-[26px] sm:text-[40px] font-bold leading-snug sm:leading-tight mb-3 sm:mb-4 text-white">
              Discover What's Really Affecting Your
            ...
            <p className="text-[14px] sm:text-[18px] text-white/90 max-w-[700px] mx-auto lg:mx-0 mb-3 sm:mb-4 leading-relaxed">
              Take our free, comprehensive assessment to understand the root
              causes behind your symptoms — and get a clear roadmap forward.
            </p>

            <p className="text-[13px] sm:text-[16px] text-white/80 mb-8 sm:mb-12">
              In just 5 minutes, you'll get insights into:
            </p>
            ...
            <p className="text-[13px] sm:text-[15px] text-white/80">
              100% free · Takes only 5 minutes · Instant clarity
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-5 sticky top-6">
              ...
              {isSubmitted && (
                <div className="mb-4 flex items-center gap-2 rounded-lg border border-green-200 bg-green-50 px-3 py-2 text-sm text-green-700">
                  ...
                  <span>Form submitted! Redirecting...</span>
                </div>
              )}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      placeholder="Tell us about your main symptoms or concerns..."
