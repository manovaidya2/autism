// File: AdultBlog.jsx (React Component)
import React, { useRef, useState, useEffect } from "react";
import axiosInstance from "../api/axiosInstance";

export default function AdultBlog() {
  ...
  const handleAddTag = () => {
    if (tagInput.trim() && !formData.tags.includes(tagInput.trim())) {
      ...
      setTagInput("");
      showMessage(`✅ Tag "${tagInput.trim()}" added successfully!`, "success");
    } else if (formData.tags.includes(tagInput.trim())) {
      showMessage("⚠️ Tag already exists!", "error");
    }
  };
  ...
  const removeTag = (tagToRemove) => {
    ...
    showMessage(`✅ Tag "${tagToRemove}" removed`, "success");
  };
  ...
  const handleEditFaq = (index) => {
    ...
    showMessage("✏️ Edit the FAQ and click Update", "success");
  };
  ...
  const handleEditorImageUpload = (e) => {
    ...
    reader.onload = (event) => {
      ...
      showMessage("✅ Image added to content!", "success");
    };
  ...
  const handleMainImageUpload = (e) => {
    ...
    reader.onload = (event) => {
      ...
      showMessage("✅ Featured image uploaded successfully!", "success");
    };
    reader.readAsDataURL(file);
  };
  ...
  const handleEditPost = (post) => {
    ...
    showMessage(`✏️ Editing: "${post.title}"`, "success");
  };
  ...
  const handleDeletePost = async (id, title) => {
    if (window.confirm(`Are you sure you want to delete "${title}"?`)) {
      try {
        ...
        showMessage(`✅ Post "${title}" deleted successfully (local)!`, "success");
      }
    }
  };
  ...
  const resetForm = () => {
    ...
    showMessage("🔄 Form cleared! Ready for new post.", "success");
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingId) {
        const response = await axiosInstance.put(`/adultblog/admin/${editingId}`, blogData);
        if (response.data && response.data.success) {
          await loadPosts();
          showMessage(`✅ Blog "${formData.title}" updated successfully!`, "success");
          resetForm();
        } else {
          throw new Error("Update failed");
        }
      } else {
        const response = await axiosInstance.post("/adultblog", blogData);
        if (response.data && response.data.success) {
          await loadPosts();
          showMessage(`🎉 Blog "${formData.title}" published successfully!`, "success");
          resetForm();
        } else {
      ...
      if (editingId) {
        ...
        showMessage(`✅ Blog "${formData.title}" updated locally!`, "success");
      } else {
        updatedPosts = [newPost, ...posts];
        showMessage(`🎉 Blog "${formData.title}" saved locally!`, "success");
      }
    ...
    return (
      <div className="mt-8 bg-white rounded-2xl shadow-xl border border-gray-100 p-6">
        <h3 className="text-xl font-bold mb-4 text-gray-800 flex items-center gap-2">
          <i className="fas fa-list"></i> Existing Posts ({posts.length})
        </h3>
        <div className="space-y-2 max-h-96 overflow-y-auto">
          {posts.map((post) => (
            <div key={post._id || post.id} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => handleDeletePost(post._id || post.id, post.title)}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-700 to-indigo-600 bg-clip-text text-transparent">
            Adult Mental Health Blog Admin
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Enter blog title (e.g., How to Overcome Burnout Naturally)"
            ...
            <div className="grid md:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="e.g., Stress Management, Anxiety Relief, Burnout Recovery"
                  className="w-full border border-gray-300 rounded-xl px-4 py-2.5"
                  required
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="2"
                placeholder="Brief summary of the blog post about mental health, stress, or anxiety..."
            ...
            <div>
              ...
              <div className="flex gap-2 mb-2">
                <input
                  ...
                  placeholder="Add a tag and press Enter (e.g., anxiety, burnout, sleep)"
            ...
            <div className="border-t border-gray-200 pt-6">
              <label className="block text-sm font-semibold text-gray-700 mb-3">
                ...
                Frequently Asked Questions (FAQs) - Mental Health Topics
              </label>
              ...
              <div className="bg-gray-50 rounded-xl p-4 mb-4">
                <div className="mb-3">
                  <input
                    ...
                    placeholder="e.g., How long does it take to recover from burnout?"
                ...
                <div className="mb-3">
                  <textarea
                    ...
                    placeholder="Answer with helpful, science-backed information..."
                    rows="2"
                ...
                {editingFaqIndex !== null && (
                  <button
                    ...
                    onClick={() => {
                      ...
                      setFaqQuestion("");
                      setFaqAnswer("");
                      showMessage("❌ FAQ edit cancelled", "success");
                    }}
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 border rounded-xl p-3 bg-gray-50 mb-2">
                ...
                <div className="w-px h-8 bg-gray-300 mx-1"></div>
                <button type="button" onClick={() => { const url = prompt("Enter link URL"); if(url) formatText("createLink", url); showMessage("🔗 Link added!", "success"); }} className="editor-btn">🔗 Link</button>
