...
export default function TeenFinalCTASection() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        localStorage.setItem("teenFinalFormData", JSON.stringify({
  ...
  return (
    <section className="bg-gradient-to-r from-[#2b3446] to-[#1f2735] py-10 px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="max-w-[700px] mx-auto lg:mx-0">
              {/* Heading */}
              <h2 className="text-[32px] md:text-[36px] font-extrabold leading-tight mb-6 text-white">
              ...
              {/* Contact Info */}
              <div className="flex flex-col sm:flex-row items-center lg:justify-start justify-center gap-3 text-[14px] text-white/80 mb-6">

                <a href="tel:+917823838638" className="hover:underline">
                  📞 +91-7823838638
                </a>
