...
import { FaStethoscope, FaUserFriends, FaStar, FaBrain, FaRegClock, FaFlask, FaChild, FaHeartbeat, FaGlobe } from "react-icons/fa";
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="md:ml-0 text-center md:text-left">
            ...
            <div className="mt-6 space-y-4 text-gray-600 text-[14px] md:text-[15px] leading-relaxed max-w-2xl mx-auto md:mx-0">
              <p>
                Dr. Ankush Garg is an Ayurvedic Neurologist and the founder of the <strong className="text-[#1f2a44]">Neuro-Ayurveda System</strong>, with over 7+ years of specialized experience in Autism, ADHD, Stress, Anxiety, Depression, OCD, and other Neurodevelopmental & Mental Health conditions.
              </p>
              <p>
                He has completed his <strong className="text-[#1f2a44]">PhD research focused on the Gut-Brain Axis</strong>, working on understanding how gut health directly impacts brain development, behaviour, mental health, and neurological conditions like autism, anxiety, depression, and OCD.
              </p>
              <p>
                With hundreds of children and adults successfully treated, his approach identifies and treats the <strong className="text-[#1f2a44]">root cause — not just symptoms</strong> — by working on both internal biology (brain, gut, hormones) and external behavioural patterns.
              </p>
              <p className="text-[#5a78ff] font-medium italic">
                ★ Special focus: Brain + Gut + Behaviour integrated treatment
              </p>
            </div>

            {/* STATS CARDS - Updated with relevant stats */}
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-5 sm:gap-4 max-w-md sm:max-w-full mx-auto md:mx-0">
              <div className="bg-[#e9ecf7] rounded-xl p-5 text-center hover:transform hover:-translate-y-1 transition-all duration-200">
                <FaRegClock className="mx-auto text-[#6c8cff] text-2xl mb-2" />
                <h3 className="font-bold text-[#1f2a44] text-[20px]">7+</h3>
              ...
              <div className="bg-[#e9ecf7] rounded-xl p-5 text-center hover:transform hover:-translate-y-1 transition-all duration-200">
                ...
                <h3 className="font-bold text-[#1f2a44] text-[20px]">500+</h3>
                <p className="text-gray-500 text-[12px] md:text-[13px]">Children & Adults Helped</p>
              </div>
              <div className="bg-[#e9ecf7] rounded-xl p-5 text-center hover:transform hover:-translate-y-1 transition-all duration-200">
                <FaFlask className="mx-auto text-[#6c8cff] text-2xl mb-2" />
                <h3 className="font-bold text-[#1f2a44] text-[20px]">PhD</h3>
                <p className="text-gray-500 text-[12px] md:text-[13px]">Gut-Brain Axis Research</p>
              </div>
            </div>

            {/* Expertise tags */}
            <div className="mt-6 flex flex-wrap gap-2 justify-center md:justify-start">
              <span className="bg-[#e9ecf7] text-[#1f2a44] text-xs px-3 py-1 rounded-full">🧠 Autism</span>
              <span className="bg-[#e9ecf7] text-[#1f2a44] text-xs px-3 py-1 rounded-full">⚡ ADHD</span>
              <span className="bg-[#e9ecf7] text-[#1f2a44] text-xs px-3 py-1 rounded-full">😰 Anxiety</span>
              <span className="bg-[#e9ecf7] text-[#1f2a44] text-xs px-3 py-1 rounded-full">😔 Depression</span>
              <span className="bg-[#e9ecf7] text-[#1f2a44] text-xs px-3 py-1 rounded-full">🔄 OCD</span>
              <span className="bg-[#e9ecf7] text-[#1f2a44] text-xs px-3 py-1 rounded-full">🌿 Stress</span>
            </div>
          </div>
        </div>
      </section>
...
const mediaLinks = [
  ...
  { name: "Flipboard", url: "https://flipboard.com/@republicnewsind/-how-dr-ankush-garg-is-redefining-autism/cast/a-i80hUB8RRhGSXe5ySX5QOA%3Aa%3A3544623556-0097b8ce16%2Frepublicnewsindia.com" },
